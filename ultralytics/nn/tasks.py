...
from ultralytics.nn.modules.seg_head import DetectionSegmentationHead
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, SPDConv, DWConv, Focus,
            ...
            c2 = ch[f[1]]
            args = [c2, *args]
        elif m in (Detect, Detect_improve, Detect_AFPN, Detect_ASFF, Detect_FRM, AsDDet, ImplicitHead, LADH, Detect_DBB, Detect_AFPN3, CLLAHead, Detect_FASFF, Detect_Adown, Detect_DySnakeConv, Detect_LSDECD, Detect_LADH, Detect_dyhead3, Detect_improve_s, Detect_SC_C, Detect_Partial_C, DetectDeepDBB, RepHead, Detect_dyhead, Segment, Pose,DetectionSegmentationHead):
